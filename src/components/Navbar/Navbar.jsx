    ...
    return (
        <div className='shadow-2xl bg-zinc-900 shadow-zinc-900 p-4 w-full text-white flex justify-center items-center rounded-b-3xl '>
            <div className='w-full max-w-[1700px] flex items-center justify-between'>
                <Link to="/MovieR/">
                    <p className="md:text-2xl font-bold flex items-center sm:text-sm"><span className='font-black md:text-3xl sm:text-xl text-red-600'>Movie</span>R<img src="https://the3dmarket.com/cdn/shop/products/new_red_cyan_blue_1024x1024.png?v=1571438517" className='w-[100px] ' /></p>
                </Link>
                ...
                <div className='p-1 rounded-3xl flex'>
                    ...
                    <button className="p-2 font-small hover:text-red-500 text-white text-2xl hidden sm:block">Login</button>
                </div>
